...
final class NetworkManager {
    ...
    private let installURL = "https://coolsterclickjupiter.click/v1/public/install" // ИЗМЕНИТЬ ДОМЕН
    private let refreshURL = "https://coolsterclickjupiter.click/v1/public/refresh" // ИЗМЕНИТЬ ДОМЕН
